...
mod test {
    ...
    fn test_get_center_absolute() {
        assert_eq!(get_center_absolute(&Rect::from(-10, -10, 10, 10), 100), CartesianP::from(0, 0));
        assert_eq!(get_center_absolute(&Rect::from(-10, -10, 10, 10), 100), CartesianP::from(0, 0));
        assert_eq!(get_center_absolute(&Rect::from(1, 1, 10, 10), 50), CartesianP::from(25, 25));
        assert_eq!(get_center_absolute(&Rect::from(4, 4, 5, 5), 10), CartesianP::from(20, 20));
        assert_eq!(get_center_absolute(&Rect::from(5, 5, 5, 5), 1), CartesianP::from(5, 5));
        assert_eq!(get_center_absolute(&Rect::from(-5, -4, 4, 5), 1000), CartesianP::from(0, 0));
        assert_eq!(get_center_absolute(&Rect::from(-4, -4, 5, 5), 1000), CartesianP::from(0, 0));
        assert_eq!(get_center_absolute(&Rect::from(-5, -4, 3, 5), 1000), CartesianP::from(-100, 0));
        assert_eq!(get_center_absolute(&Rect::from(-6, -4, 2, 5), 1000), CartesianP::from(-200, 0));
    }
}
